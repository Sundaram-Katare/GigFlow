export default function JobCard({ title, description, budget, status }) {
    return (
        <>
            <div className="bg-white p-5 rounded-2xl shadow-lg flex flex-col sm:flex-row justify-between gap-6 hover:shadow-xl transition">
                ...
                <div className="flex flex-row sm:flex-col items-center sm:items-end gap-4">
                    ...
                    <button className="bg-green-700 text-white px-5 py-2 rounded-lg text-sm font-medium hover:scale-105 transition">
                        View Details
                    </button>
                </div>
            </div>
